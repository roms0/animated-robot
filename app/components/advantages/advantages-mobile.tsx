        ...
        <Flex direction={'column'} gap={'6'}>
            ...
            <Flex  align={'center'}>
                ...
                <Box asChild flexGrow={'1'}>
                    ...
                    transition={{ type: "tween", delay: 0.5 }}
                    >
                    <Text>Decrease transportaion costs for automobile logisics <Button variant='surface' size={'1'} color="cyan">to automobiles</Button></Text>
                    </motion.div>
                </Box>
            </Flex>
            <Flex align={'center'}>
              <Box asChild flexBasis={'46px'} flexShrink={'0'} 
                ...
                <Box asChild flexGrow={'1'}>
                    ...
                    transition={{ type: "tween", delay: 0.6 }}
                    >
                    <Text>Increase car utilization rate for railroad operators <Button variant='surface' size={'1'} color="blue">to railroads</Button></Text>
                    </motion.div>
                </Box>
            </Flex>
        </Flex>
