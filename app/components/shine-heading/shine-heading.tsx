...
export const ShineHeading = () => {
    ...
    const headingScale: Responsive<"5" | "6" | "8" | "9" | "1" | "2" | "3" | "4" | "7"> | undefined = t('long') === '1' ? { initial: '4', lg: '6' } : { initial: '4', lg: '6'}
    return (
        <>
            ...
            <Heading className="accent" style={{display: 'inline'}}  wrap={'pretty'} size={headingScale}  >{main('catch.target')}</Heading>
        </>
    )
}